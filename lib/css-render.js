...
module.exports.render = function (sprite, config) {
    ...
    // Render PNG CSS
    css += exports.renderPng(exports.templates.cssSprite, spriteSelectors, sprite, config.pngPath);

    // Render SVG CSS
    css += exports.renderSvg(exports.templates.cssSpriteImage, svgSelectors, config.svgPath);
